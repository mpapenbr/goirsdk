...
func NewIrsdk() *IrsdkWin {
	mem, h := openSharedMem()
	dataEvent := openDataValidEventHandler()
	ret := IrsdkWin{sharedMem: mem, dataEventHandle: dataEvent, sharedMemHandle: h}
	ret.initialize()
	return &ret
}

func NewIrsdkWithFile(f *os.File) *IrsdkWin {
	mem := openTelemetryDump(f)

	ret := IrsdkWin{sharedMem: mem}
	ret.initialize()
...
func NewIrsdkWithConfig(config ApiConfig) *IrsdkWin {
	return &IrsdkWin{}
}
...
func (irsdk *IrsdkWin) WaitForValidData() bool {
...
//
//nolint:lll  //by design
func (irsdk *IrsdkWin) GetData() bool {
...
func (irsdk *IrsdkWin) GetYaml() (*yaml.IrsdkYaml, error) {
...
func (irsdk *IrsdkWin) GetLatestYaml() *yaml.IrsdkYaml {
	return &irsdk.irsdkYaml
}

//nolint:errcheck // by design
func (irsdk *IrsdkWin) GetYamlString() string {
	var b bytes.Buffer
...
func (irsdk *IrsdkWin) RepairedYaml(s string) string {
	work := s
...
func (irsdk *IrsdkWin) GetValue(name string) (any, error) {
	return irsdk.getValueFromBuf(name, irsdk.latestVarBuffer)
}

func (irsdk *IrsdkWin) GetIntValue(name string) (int32, error) {
...
func (irsdk *IrsdkWin) GetIntValues(name string) ([]int32, error) {
	v, err := irsdk.getValueFromBuf(name, irsdk.latestVarBuffer)
	if err != nil {
		return nil, err
	}
...
func (irsdk *IrsdkWin) GetFloatValue(name string) (float32, error) {
	v, err := irsdk.getValueFromBuf(name, irsdk.latestVarBuffer)
	if err != nil {
		return 0, err
	}
...
func (irsdk *IrsdkWin) GetDoubleValue(name string) (float64, error) {
	v, err := irsdk.getValueFromBuf(name, irsdk.latestVarBuffer)
	if err != nil {
		return 0, err
	}
...
func (irsdk *IrsdkWin) GetDoubleValues(name string) ([]float64, error) {
	v, err := irsdk.getValueFromBuf(name, irsdk.latestVarBuffer)
	if err != nil {
		return nil, err
	}
...
func (irsdk *IrsdkWin) GetFloatValues(name string) ([]float32, error) {
	v, err := irsdk.getValueFromBuf(name, irsdk.latestVarBuffer)
	if err != nil {
		return nil, err
	}
...
func (irsdk *IrsdkWin) GetBoolValue(name string) (bool, error) {
	v, err := irsdk.getValueFromBuf(name, irsdk.latestVarBuffer)
	if err != nil {
		return false, err
	}
...
func (irsdk *IrsdkWin) GetBoolValues(name string) ([]bool, error) {
	v, err := irsdk.getValueFromBuf(name, irsdk.latestVarBuffer)
	if err != nil {
		return nil, err
	}
...
func (irsdk *IrsdkWin) GetValueKeys() []string {
...
func (irsdk *IrsdkWin) WriteDump(w io.Writer) (int, error) {
	return w.Write(irsdk.sharedMem)
}

func (irsdk *IrsdkWin) DumpHeaders() {
	fmt.Printf("Header\n%+v\n", irsdk.hdr)
...
func (irsdk *IrsdkWin) initialize() {
...
func (irsdk *IrsdkWin) getValueFromBuf(name string, buf []byte) (any, error) {
